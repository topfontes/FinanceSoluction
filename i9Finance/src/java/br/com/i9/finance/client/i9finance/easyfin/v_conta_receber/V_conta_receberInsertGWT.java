 ...
 * @author EasyNet
 */
public class V_conta_receberInsertGWT extends CRUDBaseGWT  {
    protected V_conta_receberConsultGWT v_conta_receberConsult;
    ...
    public V_conta_receberInsertGWT() {
        getBtnDelete().setVisible(false);
        getBtnUpdate().setVisible(false);
	setHeading("Cadastrar V_conta_receber");
  ...
  public void btnInsertAction(ButtonEvent ce){
    ...
    v_conta_receberAsync.insert(v_conta_receberT, callback);
