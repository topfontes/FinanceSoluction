 ...
 * @author marcos
 */
public class ContasAPagar_RelGWT extends RelatorioBaseGWT {

    private RadioGroup radioGroup = new RadioGroup();
    private Radio rAberto = new Radio();
    private Radio rQuitado = new Radio();

    public ContasAPagar_RelGWT() {
    ...
    public String getURL() {
        return Constantes.URL+Constantes.PATH_RELATORIO + "V_conta_pagar/v_conta_pagarReport.jsp?op=imprimir"+getParam();
    }
