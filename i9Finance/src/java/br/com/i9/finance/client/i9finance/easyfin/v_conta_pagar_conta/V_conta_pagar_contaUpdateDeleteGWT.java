 ...
 * @author geoleite
 */
public class V_conta_pagar_contaUpdateDeleteGWT extends V_conta_pagar_contaInsertGWT {
    private V_conta_pagar_contaT v_conta_pagar_contaT;

    public V_conta_pagar_contaUpdateDeleteGWT() {
        getBtnClear().setVisible(false);
        getBtnInsert().setVisible(false);
        getBtnUpdate().setVisible(true);
        getBtnDelete().setVisible(true);

        setHeading("Alterar V_conta_pagar_conta");
    }

    public void load(V_conta_pagar_contaT v_conta_pagar_contaT) {
	this.v_conta_pagar_contaT = v_conta_pagar_contaT;
		dt_pagamento.setValue(v_conta_pagar_contaT.getDt_pagamento());
		valor.setValue(v_conta_pagar_contaT.getValor() + "");
		id_cli_fab.setValue(v_conta_pagar_contaT.getId_cli_fab() + "");
		nome.setValue(v_conta_pagar_contaT.getNome());
		fop_nr_id.setValue(v_conta_pagar_contaT.getFop_nr_id() + "");
		forma.setValue(v_conta_pagar_contaT.getForma());
		ban_nr_id.setValue(v_conta_pagar_contaT.getBan_nr_id() + "");
		banco.setValue(v_conta_pagar_contaT.getBanco());
		pago.setValue(v_conta_pagar_contaT.getPago());
		parcela.setValue(v_conta_pagar_contaT.getParcela());
		documento.setValue(v_conta_pagar_contaT.getDocumento() + "");
		dt_emissao.setValue(v_conta_pagar_contaT.getDt_emissao());
		vencimento.setValue(v_conta_pagar_contaT.getVencimento());
		obs.setValue(v_conta_pagar_contaT.getObs());
		car_nr_id.setValue(v_conta_pagar_contaT.getCar_nr_id() + "");
		cartao.setValue(v_conta_pagar_contaT.getCartao());
		plc_nr_id.setValue(v_conta_pagar_contaT.getPlc_nr_id() + "");
		conta.setValue(v_conta_pagar_contaT.getConta());
		loj_nr_id.setValue(v_conta_pagar_contaT.getLoj_nr_id() + "");
  ...
  public void btnUpdateAction(ButtonEvent ce) {
    ...
    v_conta_pagar_contaAsync.update(v_conta_pagar_contaT, callback);	
  }
 }
  ...
  public void btnDeletetAction(ButtonEvent ce) {
    ...
    MessageBox.confirm(EASY_LABELS.warning(), EASY_LABELS.messageDeleteConfirm(), new Listener<MessageBoxEvent>() {
      ...
      public void handleEvent(MessageBoxEvent be) {
        ...
        V_conta_pagar_contaServiceAsync v_conta_pagar_contaAsync = GWT.create(V_conta_pagar_contaService.class);
        v_conta_pagar_contaAsync.delete(v_conta_pagar_contaT, callback);	
      }
    }
  });
 }
