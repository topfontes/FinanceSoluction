 ...
 * @author EasyNet
 */
public class V_conta_receber_contaInsertGWT extends CRUDBaseGWT  {
    protected V_conta_receber_contaConsultGWT v_conta_receber_contaConsult;
    ...
    public V_conta_receber_contaInsertGWT() {
        getBtnDelete().setVisible(false);
        getBtnUpdate().setVisible(false);
	setHeading("Cadastrar V_conta_receber_conta");
  ...
  public void btnInsertAction(ButtonEvent ce){
    ...
    v_conta_receber_contaAsync.insert(v_conta_receber_contaT, callback);
