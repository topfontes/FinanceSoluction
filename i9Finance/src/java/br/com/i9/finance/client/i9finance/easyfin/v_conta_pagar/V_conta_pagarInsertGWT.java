 ...
 * @author EasyNet
 */
public class V_conta_pagarInsertGWT extends CRUDBaseGWT  {
    protected V_conta_pagarConsultGWT v_conta_pagarConsult;
    ...
    public V_conta_pagarInsertGWT() {
        getBtnDelete().setVisible(false);
        getBtnUpdate().setVisible(false);
	setHeading("Cadastrar V_conta_pagar");
  ...
  public void btnInsertAction(ButtonEvent ce){
    ...
    v_conta_pagarAsync.insert(v_conta_pagarT, callback);
