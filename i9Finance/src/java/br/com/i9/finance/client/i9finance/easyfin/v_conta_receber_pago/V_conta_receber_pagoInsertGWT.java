 ...
 * @author EasyNet
 */
public class V_conta_receber_pagoInsertGWT extends CRUDBaseGWT  {
    protected V_conta_receber_pagoConsultGWT v_conta_receber_pagoConsult;
    ...
    public V_conta_receber_pagoInsertGWT() {
        getBtnDelete().setVisible(false);
        getBtnUpdate().setVisible(false);
	setHeading("Cadastrar V_conta_receber_pago");
  ...
  public void btnInsertAction(ButtonEvent ce){
    ...
    v_conta_receber_pagoAsync.insert(v_conta_receber_pagoT, callback);
