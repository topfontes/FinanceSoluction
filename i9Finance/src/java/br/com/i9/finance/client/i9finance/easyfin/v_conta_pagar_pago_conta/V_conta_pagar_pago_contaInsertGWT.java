 ...
 * @author EasyNet
 */
public class V_conta_pagar_pago_contaInsertGWT extends CRUDBaseGWT  {
    protected V_conta_pagar_pago_contaConsultGWT v_conta_pagar_pago_contaConsult;
    ...
    public V_conta_pagar_pago_contaInsertGWT() {
        getBtnDelete().setVisible(false);
        getBtnUpdate().setVisible(false);
	setHeading("Cadastrar V_conta_pagar_pago_conta");
  ...
  public void btnInsertAction(ButtonEvent ce){
    ...
    v_conta_pagar_pago_contaAsync.insert(v_conta_pagar_pago_contaT, callback);
