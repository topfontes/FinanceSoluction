 ...
 */
public class V_lancamentosT extends BaseModel {
  ...
  public static final String PLC_TX_CREDITO = "plc_tx_credito";
  public static final String PLC_TX_DEBITO = "plc_tx_debito";
  public static final String PLC_TX_CREDITO_SUPER = "plc_tx_credito_super";
  public static final String PLC_TX_DEBITO_SUPER ="plc_tx_debito_super";
  public static final String PLC_SUPER ="plc_super";
  public static final String TIPO_CRED ="tipo_cred";
  public static final String TIPO_DEB ="tipo_deb";
  


  public V_lancamentosT() {
  }
  ...
  public String getPlc_tx_credito() {
    return   get(PLC_TX_CREDITO)==null?"": (String)get(PLC_TX_CREDITO);
  }

  public void setPlc_tx_credito(String plc_tx_credito) {
    set(PLC_TX_CREDITO, plc_tx_credito);
  }

  public String getPlc_tx_debito() {
    return   get(PLC_TX_DEBITO)==null?"": (String)get(PLC_TX_DEBITO);
  }

  public void setPlc_tx_debito(String plc_tx_debito) {
    set(PLC_TX_DEBITO, plc_tx_debito);
  }

  public String getplc_tx_debito_super() {
    return   get(PLC_TX_DEBITO_SUPER)==null?"": (String)get(PLC_TX_DEBITO_SUPER);
  }

  public void setplc_tx_debito_super(String plc_tx_debito_super) {
    set(PLC_TX_DEBITO_SUPER, plc_tx_debito_super);
  }

  public String getPlc_tx_credito_super() {
    return   get(PLC_TX_CREDITO_SUPER)==null?"": (String)get(PLC_TX_CREDITO_SUPER);
  }

  public void setPlc_tx_credito_super(String plc_tx_credito_super) {
    set(PLC_TX_CREDITO_SUPER, plc_tx_credito_super);
  }  
  
  
  public String getPlc_super() {
    return   get(PLC_SUPER)==null?"": (String)get(PLC_SUPER);
  }

  public void setPlc_super(String plc_super) {
    set(PLC_SUPER, plc_super);
  }    
  
  
  public String getTipo_deb() {
    return   get(TIPO_DEB)==null?"": (String)get(TIPO_DEB);
  }

  public void setTipo_deb(String tipo_deb) {
    set(TIPO_DEB, tipo_deb);
  }   
  
   public String getTipo_cred() {
    return   get(TIPO_CRED)==null?"": (String)get(TIPO_CRED);
  }

  public void setTipo_cred(String tipo_cred) {
    set(TIPO_CRED, tipo_cred);
  }  
}
