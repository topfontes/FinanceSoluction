...
<jsp:useBean id="op_ope_perJB" class="br.com.easynet.easyportal.jb.Op_ope_perUpdateDeleteJB" scope="request"/>                                         
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="90%">
        <tr>
          <td class="pageName" align="center">op_ope_per </td>
		</tr>
...
<form action="op_ope_perUpdateDelete.jsp" method="post"   >                                         
