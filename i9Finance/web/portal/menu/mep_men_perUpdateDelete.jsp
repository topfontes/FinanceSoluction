...
<jsp:useBean id="mep_men_perJB" class="br.com.easynet.easyportal.menu.jb.Mep_men_perUpdateDeleteJB" scope="request"/>                                         
...
<form action="mep_men_perUpdateDelete.jsp" method="post"   >                                         
