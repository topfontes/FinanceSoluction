...
<form action="men_menuUpdateDelete.jsp" method="post"   >                                         
    <input type="hidden" name="op"/>
    <center>     
     	<label class="errorMessage">${men_menuJB.msg}</label><br/>

    <label>men_nr_id:</label><input type="text" name="men_menuT.men_nr_id" value="${men_menuJB.men_menuT.men_nr_id}"/>  <br/>
<label>supermenu_nr_id:</label><input type="text" name="men_menuT.supermenu_nr_id" value="${men_menuJB.men_menuT.supermenu_nr_id}"/>  <br/>
<label>men_tx_status:</label><input type="text" name="men_menuT.men_tx_status" value="${men_menuJB.men_menuT.men_tx_status}"/>  <br/>
<label>men_tx_nome:</label><input type="text" name="men_menuT.men_tx_nome" value="${men_menuJB.men_menuT.men_tx_nome}"/>  <br/>
<label>men_nr_ordem:</label><input type="text" name="men_menuT.men_nr_ordem" value="${men_menuJB.men_menuT.men_nr_ordem}"/>  <br/>
